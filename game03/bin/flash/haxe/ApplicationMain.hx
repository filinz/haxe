...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("game03", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("game03", null, 800, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "game03";
		app.meta["name"] = "game03";
		app.meta["packageName"] = "game03";
