...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("game01", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("game01", null, 800, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "game01";
		app.meta["name"] = "game01";
		app.meta["packageName"] = "game01";
