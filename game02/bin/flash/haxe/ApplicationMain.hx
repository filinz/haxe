...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("game02", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("game02", null, 800, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "game02";
		app.meta["name"] = "game02";
		app.meta["packageName"] = "game02";
