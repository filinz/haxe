...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("haxecowboy", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("haxecowboy", null, 800, 400);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "haxecowboy";
		app.meta["name"] = "haxe_cowboy";
		app.meta["packageName"] = "haxecowboy";
